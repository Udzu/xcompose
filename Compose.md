...
### Latin script characters (2747)
* **International Phonetic Alphabet** (139): ⫽ˈɹɛ.dɪt⫽ [aɪ̯ pʰiː eɪ̯] etc
...
### Non-Latin script characters (32911)
...
* **Cyrillic**, Glagolitic & Old Permic (573): Ре́ддит, Ⱃⰵδδιτ, 𐍠𐍔𐍓𐍓𐍙𐍢 etc
...
* **Sprites** (150): 🗫 🯅 ㋡ etc
* **Math and science** (512): ρ(∂v⃗/∂t + (v⃗·∇)v) ∫πeⁱᶿ dθ etc.
* **APL** (107): ⍟ ⍫ ⍉ etc
* **Technical** (106): ⏻ ⎙ ⌘ etc
